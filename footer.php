...
<div class="setting_tool iconfont">
    ...
    <div class="s">
        <form method="get" action="<?php bloginfo('url'); ?>" class="search">
            <input class="search-key" name="s" autocomplete="off" placeholder="キーワードなど..." type="text" value="" required="required">
        </form>
    </div>
    <div class="c">
        <ul>
            <li class="color undefined">Default</li>
            <li class="color sepia">Reading</li>
            <li class="color night">Dark</li>
            <li class="hr"></li>
...
<!--サイト情報：<?php timer_stop(4); ?>秒内<?= get_num_queries(); ?>回データベースをアクセスしました-->
</body>
</html>
